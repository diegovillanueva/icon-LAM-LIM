...
/home/ms/datex/gdr/scripts_diego/icon/mars4icon/mars4icon_smi_new -r 1279 -l 1/to/137 -d ${year}-${month}-${day}T${hour} -s 3 -O -L 15 -o ${year_name}${month_name}${day_name}_T${hour_name}.grb -p 10 &> ${year}-${month}-${day}T${hour}.err
